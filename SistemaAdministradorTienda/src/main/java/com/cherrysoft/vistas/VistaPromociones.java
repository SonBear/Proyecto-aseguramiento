...
public class VistaPromociones extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Detalles de la promoción"));
        ...
        jButton1.setText("Crear promoción");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaPromociones().setVisible(true);
            }
        });
    }
